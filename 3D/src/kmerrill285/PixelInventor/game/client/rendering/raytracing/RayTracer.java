...
public class RayTracer {
	...
	public void render() {
		...
		if (PixelInventor.game.framebuffer.getDepthMapTexture() != null) {
			GL30.glActiveTexture(GL30.GL_TEXTURE1);
			glBindTexture(GL_TEXTURE_2D, PixelInventor.game.framebuffer.getDepthMapTexture().getTextureId());
			
			GL30.glActiveTexture(GL30.GL_TEXTURE2);
			glBindTexture(GL_TEXTURE_2D, PixelInventor.game.framebuffer.getTexture().getTextureId());
			
			shader.setFloat("depth", Utils.Z_FAR - Utils.Z_NEAR);
			shader.setFloat("z_near", Utils.Z_NEAR);
		}
