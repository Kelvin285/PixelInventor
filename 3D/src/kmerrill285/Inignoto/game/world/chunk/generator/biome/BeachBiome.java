...
public class BeachBiome extends Biome {
	...
	public BeachBiome() {
		super(Tiles.SAND, Tiles.SAND, Tiles.SMOOTH_STONE, BiomeHumidity.HUMID, BiomeTemperature.WARM, BiomeLocation.LAND, BiomeType.SHALLOW_OCEAN);
	}

	@Override
	public float getHeightAt(float x, float y, float z, FastNoise noise) {
		return MathHelper.average(noise.GetSimplex(x * 0.25f, z * 0.25f), noise.GetSimplexFractal(x, z)) * 10 - 5;
	}
