...
namespace Inignoto.Graphics.Shadows
{
    ...
    {
        public RenderTarget2D[] shadowMapRenderTarget = new RenderTarget2D[2];
        ...
        public ShadowMap(Vector3 lightPosition, Vector3 _lightDirection)
        {
            ...
            shadowMapRenderTarget[0] = new RenderTarget2D(Inignoto.game.GraphicsDevice, 2048 * 2, 2048 * 2, false, SurfaceFormat.Single, DepthFormat.Depth24, 2, RenderTargetUsage.DiscardContents);
