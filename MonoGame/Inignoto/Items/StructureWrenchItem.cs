...
namespace Inignoto.Items
{
    ...
    {
        public static Vector3 pos1 = new Vector3(float.MaxValue);
        public static Vector3 pos2 = new Vector3(float.MaxValue);
        ...
        protected override ActionResult Attack(Entity user, GameTime time, World.RaytraceResult.TileRaytraceResult result)
        {
            ...
            pos1 = new Vector3(result.pos.x, result.pos.y, result.pos.z);
        ...
        protected override ActionResult Use(Entity user, GameTime time)
        {
            ...
            TileRaytraceResult result = world.RayTraceTiles(eyePosition, eyePosition + (user.ForwardLook * (user.ReachDistance)), Tiles.Tile.TileRayTraceType.BLOCK);

            if (result == null) return ActionResult.MISS;

            Inignoto.game.client_system.SendChatMessage(-1, "Position 2 set to [" + result.pos.x + ", " + result.pos.y + ", " + result.pos.z + "]");

            pos2 = new Vector3(result.pos.x, result.pos.y, result.pos.z);
