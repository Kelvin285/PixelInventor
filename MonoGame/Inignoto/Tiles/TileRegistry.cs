...
namespace Inignoto.Tiles
{
    public class TileRegistry
    {
        ...
        public static void Loadtiles()
        {
            ...
            CANDENTIS = new PlantTile("Inignoto:candentis", new Tile[] { DIRT, LOG }).SetLight(0, 0, 4).SetTransparent();
            TALL_GRASS = new PlantTile("Inignoto:tall_grass", new Tile[] { DIRT }).SetTransparent();
        }
